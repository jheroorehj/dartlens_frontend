import { RechartsScale } from 'recharts/types/util/ChartUtils';
import { AxisDomain, CartesianTickItem, CategoricalDomain, Coordinate, LayoutType, NumberDomain, Size, StackOffsetType, TickItem } from 'recharts/types/util/types';
import { AxisId, BaseCartesianAxis, CartesianAxisSettings, XAxisOrientation, XAxisSettings, YAxisOrientation, YAxisSettings, ZAxisSettings } from 'recharts/types/state/cartesianAxisSlice';
import { RechartsRootState } from 'recharts/types/state/store';
import { AppliedChartData, ChartData, ChartDataState } from 'recharts/types/state/chartDataSlice';
import { CartesianGraphicalItemSettings, GraphicalItemSettings, PolarGraphicalItemSettings } from 'recharts/types/state/graphicalItemsSlice';
import { ReferenceAreaSettings, ReferenceDotSettings, ReferenceElementSettings, ReferenceLineSettings } from 'recharts/types/state/referenceElementsSlice';
import { AxisPropsForCartesianGridTicksGeneration } from 'recharts/types/cartesian/CartesianGrid';
import { AngleAxisSettings, RadiusAxisSettings } from 'recharts/types/state/polarAxisSlice';
import { AllStackGroups } from 'recharts/types/util/stacks/stackTypes';
import { DisplayedStackedData } from 'recharts/types/state/selectors/combiners/combineDisplayedStackedData';
import { DefinitelyStackedGraphicalItem } from 'recharts/types/state/types/StackedGraphicalItem';
import { ErrorBarsSettings, ErrorBarsState } from 'recharts/types/state/errorBarSlice';
/**
...
export declare const selectDomainOfStackGroups: ((state: import("redux").EmptyObject & {
    brush: import("recharts/types/state/brushSlice").BrushSettings;
    cartesianAxis: {
    ...
    graphicalItems: import("recharts/types/state/graphicalItemsSlice").GraphicalItemsState;
    layout: {
    ...
    legend: {
        settings: import("recharts/types/state/legendSlice").LegendSettings;
        size: Size;
        payload: ReadonlyArray<ReadonlyArray<import("recharts").LegendPayload>>;
    };
    options: import("recharts/types/state/optionsSlice").ChartOptions;
    polarAxis: {
        radiusAxis: Record<AxisId, RadiusAxisSettings>;
        angleAxis: Record<AxisId, AngleAxisSettings>;
    };
    polarOptions: import("recharts/types/state/polarOptionsSlice").PolarChartOptions;
    referenceElements: {
    ...
    rootProps: import("recharts/types/state/rootPropsSlice").UpdatableChartOptions;
    tooltip: import("recharts/types/state/tooltipSlice").TooltipState;
