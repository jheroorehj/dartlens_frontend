...
import { BarPositionPosition, StackId } from 'recharts/types/util/ChartUtils';
import { ActiveShape, AnimationDuration, CartesianViewBoxRequired, ChartOffsetInternal, Coordinate, DataKey, LegendType, PresentationAttributesAdaptChildEvent, TickItem, TooltipType } from 'recharts/types/util/types';
import { MinPointSize } from 'recharts/types/util/BarUtils';
import { BaseAxisWithScale } from 'recharts/types/state/selectors/axisSelectors';
import { BarSettings } from 'recharts/types/state/types/BarSettings';
import { EasingInput } from 'recharts/types/animation/easing';
type Rectangle = {
    x: number | null;
    y: number | null;
    width: number;
