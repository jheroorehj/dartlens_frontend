...
import { AxisInterval, AxisTick, BaseAxisProps, PresentationAttributesAdaptChildEvent } from 'recharts/types/util/types';
import { YAxisOrientation, YAxisPadding, YAxisWidth } from 'recharts/types/state/cartesianAxisSlice';
...
export declare const yAxisDefaultProps: {
    ...
    readonly scale: import("recharts/types/util/types").ScaleType | import("recharts/types/util/ChartUtils").RechartsScale;
    readonly tickCount: number;
    readonly type: import("recharts/types/util/types").AxisDomainType;
